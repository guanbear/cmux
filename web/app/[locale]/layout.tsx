...
export default async function LocaleLayout({
  ...
  const webSiteJsonLd = {
    ...
    url: "https://cmux.com",
    description:
      "Free and open source native macOS terminal built on Ghostty for AI coding agents, vertical workspaces, notification rings, split panes, and a scriptable CLI.",
    publisher: {
      "@type": "Organization",
      name: "cmux",
      url: "https://cmux.com",
